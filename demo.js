...
async function run() {  
    ...
    await page.goto("https://reflektivedev.wpengine.com/contact/", {timeout: 120000,slowMo: 2000,waitUntil: ['load', 'networkidle2']});
...
if (await page.$('#Phone') !== null){
    ...
    console.log(data.contact.inquiry_details);
    await browser.close();
}
run();